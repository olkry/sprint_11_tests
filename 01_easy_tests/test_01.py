...
mixed_numbers = [3, 2.5, 8, 4.1]  # Список из int и float.
# Ожидаемый результат, который должна вернуть функция series_sum().
result_numbers = '32.584.1'
...
mixed_numbers_strings = [3, 'try', '8', 4.1]  # Cписок из чисел и строк.
# Ожидаемый результат, который должна вернуть series_sum().
result_numbers_strings = '3try84.1'
